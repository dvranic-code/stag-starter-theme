...
if ( ! class_exists( 'ThemeSetup' ) ) {
	...
	class ThemeSetup {
		...
		public function __construct() {
			add_action( 'after_setup_theme', array( $this, 's_setup' ) );
			add_action( 'after_setup_theme', array( $this, 's_content_width' ) );
			add_filter( 'body_class', array( $this, 's_body_classes' ) );
			add_action( 'wp_head', array( $this, 's_pingback_header' ) );
		}
		...
		public function s_content_width() {
			$GLOBALS['content_width'] = apply_filters( 's_content_width', 640 );
		}
