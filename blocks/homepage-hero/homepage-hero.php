...
<section <?php echo esc_attr( $anchor ); ?>class="<?php echo esc_attr( $class_name ); ?>">
	<div class="homepage-hero__caption">
		<div class="grid-col">
			...
			<?php if ( $hero_button ) : ?>
				<a class="btn btn--ghost" href="<?php echo esc_url( $hero_button['url'] ); ?>" class="button"><?php echo esc_html( $hero_button['title'] ); ?></a>
			<?php endif; ?>
		</div>
	</div>
	<div class="homepage-hero__background">
		...
		<?php
		if ( $video_background ) :
			echo $video_background; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
			?>
		</div>
